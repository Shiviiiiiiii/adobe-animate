    ...
    <header class="header clearfix">
        <div class="clearfix display-flex align-items contentHolder" data-items="center">
            ...
            <nav class="menu">
                ...
                <ul class="submenu">
                  <li class="subOption"><a href="membre_du_bureau.html">Membre du bureau</a></li>
                  <li class="subOption"><a href="origine_du_site.html">Origine du site</a></li>
              ...
              <li class="mainMenu"><a href="">Licenciés</a>
                <ul class="submenu">
                      <li class="subOption"><a href="pourquoi_etre_licencie.html">Pourquoi étre licencié ?</a></li>
                      <li class="subOption"><a href="Licence_et_tarif.html">Licence et tarifs</a></li>
                </ul>
              </li>
              <li class="mainMenu"><a href="">Pistes</a>
                <ul class="submenu">
                    <li class="subOption"><a href="les_pistes.html">Circuits</a></li>
                </ul>
              </li>
