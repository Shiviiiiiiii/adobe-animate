...
<body>
  ...
  <?php include"entete.php"?>
    ...
    <br></br>
    <br></br>
    <h1>L'origine de ce site web</h1>
        <p>
            Ce site web a été créé pour un projet précit qui est d'organiser ainsi de gérer une course de voiture télécommandées. Ce site réunit toutes les informations ainsi que les outils nécessaires pour méner à bien une course.
